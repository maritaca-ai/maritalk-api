...
Este tutorial mostra como executar a MariTalk Local na Oracle Cloud Infrastructure (OCI). Para isso, nós vamos utilizar Docker em uma instância com GPU Nvidia A10 (`VM.GPU.A10.1`).
