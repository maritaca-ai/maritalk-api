...
Este tutorial mostra como executar o MariTalk Local na Google Cloud Platform (GCP). Para isso, utilizaremos Docker em uma instância com a GPU NVIDIA L4 24GB.
