...
General-purpose model focused on agentic capability and Brazilian context, updated through August 2024 and recommended for uses that need accuracy with cost efficiency.
...
| **Input (per 1M tokens)** | R$ 5.00 | R$ 1.00 | R$ 5.00 | R$ 5.00 | R$ 1.00 |
| **Output (per 1M tokens)** | R$ 20.00 | R$ 4.00 | R$ 10.00 | R$ 10.00 | R$ 3.00 |
...
<small>¹ Off-peak: 10 p.m.–6 a.m. BRT. Prices per million tokens.</small>
